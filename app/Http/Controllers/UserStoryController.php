...
class UserStoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $userStories = $request->validate([
            ...
            'email' => 'email:rfc,dns|max:150|unique:user_stories,email',
            ...
            'bank_account_name' => 'string|max:150',
            'bank_account_number' => 'string|max:50',
            'scan_ktp_url_drive' => 'file|mimes:jpg,jpeg,png,pdf|max:2048',
        ]);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            'date_of_birth' => 'date',
            'phone' => 'required|string|max:20',
            'email' => 'email:rfc,dns|max:150|unique:user_stories,email' . $id,
            'province' => 'string|max:100',
            'city' => 'string|max:100',
            'street_address' => 'string|max:255',
            'zip_code' => 'string|max:10',
